...
//    //In the status --> @tweeter   weather    location    Json.weather.description. find the tweet.text tweet.who tweet.location
...
var newScheduler = schedule.scheduleJob('* * * * *', function(){
...
mg.sendText('cronCron@cron.com', 'doug@kosmojo.com',
    newScheduler,
    newScheduler,
    function(err){
        if(err) console.log('Oh noses: ' + err);
